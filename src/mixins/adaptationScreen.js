...
export default {
  ...
  methods: {
       ...
       * @param {*} element 样式元素
       */
      adaptiveFontSize(styleObj, element, isImportant = false) {
          styleObj['font-size'] = this.getAdaptiveSize(element.fontSize) + element.fontSizeUnit + (isImportant ? ' !important': '')
      }
  }
}
