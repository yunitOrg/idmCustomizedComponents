...
<script>
import UnitSchedule from '../commonComponents/travelSchedule/UnitSchedule.vue'
import WeekSchedule from '../commonComponents/travelSchedule/WeekSchedule.vue'
export default {
  name: 'ITravelSchedule',
  components:{
    UnitSchedule,
    WeekSchedule  
  },
