<template>
  <div idm-ctrl="idm_module" :id="moduleObject.id" :idm-ctrl-id="moduleObject.id" class="IPaySystemPerson_app">
    ...
    <div class="main">
      <div class="tab_block flex_between">
        <div @click="handleClickTab" class="left flex_start">
          <div data-value="baseSalaryList" class="button_list" :class="active_tab == 'baseSalaryList' ? 'active' : ''">基本工资</div>
          <div data-value="subsidySalaryList" class="button_list" :class="active_tab == 'subsidySalaryList' ? 'active' : ''">津补贴</div>
          <div data-value="disposableSalaryList" class="button_list" :class="active_tab == 'disposableSalaryList' ? 'active' : ''">一次性收入</div>
          <div data-value="bonusSalaryList" class="button_list" :class="active_tab == 'bonusSalaryList' ? 'active' : ''">年终一次性奖金</div>
        </div>
        <div class="right button_block flex_end">
          <div @click="exportData()" class="button_box primary">导出明细</div>
        </div>
      </div>
      <div class="table">
        <div ref="tableHeader" class="table_header flex_between">
          <template v-for="(item,index) in header_object[active_tab]">
            <div :key="index" class="cell flex_center">
